...
data class Company(
  @Id @GeneratedValue val id: CompanyId,
  val name: String,
  @OneToMany(fetch = FetchType.LAZY, mappedBy = "company") val employees: Set<CompanyMember>?,
  @Column(name = "address_id") val addressId: AddressId?,
