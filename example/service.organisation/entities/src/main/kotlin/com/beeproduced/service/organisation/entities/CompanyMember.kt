...
data class CompanyMemberId(
  @Column(name = "company_id") val companyId: CompanyId,
  @Column(name = "person_id") val personId: PersonId,
) : Serializable
...
data class CompanyMember(
  @Id @Column(name = "company_id") val companyId: CompanyId,
  @Id @Column(name = "person_id") val personId: PersonId,
