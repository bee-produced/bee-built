 ...
 */
@Configuration
class CompanyEvents(private val eventManager: EventManager, private val service: CompanyService) {
  @PostConstruct
  ...
  private fun exists(request: CompaniesExist): AppResult<Unit> = service.exists(request.ids)
}
