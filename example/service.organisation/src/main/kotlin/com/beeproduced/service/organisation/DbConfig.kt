...
class DbConfig(val env: Environment) {
  ...
  fun userEntityManager(
    @Qualifier("organisationDataSource") dataSource: DataSource
    ...
    properties["hibernate.hbm2ddl.auto"] =
      requireNotNull(env.getProperty("spring.jpa.hibernate.ddl-auto"))
    properties["hibernate.dialect"] =
      requireNotNull(env.getProperty("spring.jpa.properties.hibernate.dialect"))
  ...
  fun userTransactionManager(
    @Qualifier("organisationEntityManager") userEntityManager: AbstractEntityManagerFactoryBean
