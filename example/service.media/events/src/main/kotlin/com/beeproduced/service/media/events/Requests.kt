 ...
 * @version 2023-09-26
 */
data class CreateFilm(val create: CreateFilmInput, val selection: DataSelection) : Request<Film>

data class UpdateFilm(val update: UpdateFilmInput, val selection: DataSelection) : Request<Film>

data class GetAllFilms(val selection: DataSelection) : Request<Collection<Film>>

data class GetRecentlyAddedFilms(val pagination: FilmPagination, val selection: DataSelection) :
