...
annotation class TransactionalResult(
    ...
    /**
     * Determines what description the returned [com.beeproduced.result.errors.InternalError] will have when
     * an exception is thrown in a method surrounded by [TransactionalResult].
     */
