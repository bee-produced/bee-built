...
import com.beeproduced.result.errors.ExceptionError
import com.beeproduced.result.errors.InternalAppError
import com.beeproduced.result.errors.ResultError
import com.beeproduced.result.extensions.errors.mapBadRequestError
import com.beeproduced.result.extensions.errors.mapInternalError
...
class ErrorTest {
    ...
    fun `map bad request to bad request via lambda`() {
        ...
        val error1LineNumber = lineNumberBefore()
        val error1StackTrace = error1.stackTraceToString()
        val error2 = Err(error1).mapBadRequestError { e -> BadRequestError(error2Description, e) }
    ...
    fun `map bad request to bad request via description`() {
        ...
        val error1LineNumber = lineNumberBefore()
        val error1StackTrace = error1.stackTraceToString()
        val error2 = Err(error1).mapBadRequestError(error2Description)
            .getErrorOrElse { throw IllegalArgumentException() }
        val error2LineNumber = lineNumberBefore() - 1
        val error2StackTrace = error2.stackTraceToString()
        val error2LineCount = lineCount(error2StackTrace)
    ...
    fun `omit bad request mapping because internal error mapping via lambda`() {
        ...
        val error1LineNumber = lineNumberBefore()
        val error1StackTrace = error1.stackTraceToString()
        val error2 = Err(error1).mapInternalError { e -> InternalAppError(error2Description, e) }
            .getErrorOrElse { throw IllegalArgumentException() }
        val error2LineNumber = lineNumberBefore() - 1
        val error2StackTrace = error2.stackTraceToString()
        val error2LineCount = lineCount(error2StackTrace)
    ...
    fun `omit bad request mapping because internal error mapping via description`() {
        ...
        val error1LineNumber = lineNumberBefore()
        val error1StackTrace = error1.stackTraceToString()
        val error2 = Err(error1).mapInternalError(error2Description)
            .getErrorOrElse { throw IllegalArgumentException() }
        val error2LineNumber = lineNumberBefore() - 1
        val error2StackTrace = error2.stackTraceToString()
        val error2LineCount = lineCount(error2StackTrace)
    ...
    fun `map bad request to custom bad request via lambda`() {
        ...
        val error1LineNumber = lineNumberBefore()
        val error1StackTrace = error1.stackTraceToString()
        val error2 = Err(error1).mapBadRequestError { e -> CustomBadRequest(error2Description, e) }
            .getErrorOrElse { throw IllegalArgumentException() }
        val error2LineNumber = lineNumberBefore() - 1
        val error2StackTrace = error2.stackTraceToString()
        val error2LineCount = lineCount(error2StackTrace)
