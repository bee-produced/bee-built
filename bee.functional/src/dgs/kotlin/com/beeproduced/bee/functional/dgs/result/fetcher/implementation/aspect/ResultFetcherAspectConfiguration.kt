...
abstract class ResultFetcherAspectConfiguration {
  ...
  init {
    ...
    val aspectAnnotation =
      AnnotationUtils.findAnnotation(this::class.java, EnableAspectJAutoProxy::class.java)
    if (aspectAnnotation == null) {
      throw IllegalStateException(
        "DGS-Error-Handling: [${this::class.simpleName}] must be annotated with [org.springframework.context.annotation.EnableAspectJAutoProxy]"
      )
    }
  }
