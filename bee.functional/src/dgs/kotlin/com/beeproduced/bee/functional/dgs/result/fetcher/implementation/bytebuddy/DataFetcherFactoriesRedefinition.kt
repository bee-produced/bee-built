...
/**
 * Allows data fetchers to return `com.github.michaelbull.result.Result` natively
 * with the help of ByteBuddy.
 *
 * Based on: https://github.com/graphql-java/graphql-java/blob/5eb2ab743bf7afc05e2243d3dc0bcf22a0384366/src/main/java/graphql/schema/DataFetcherFactories.java
 *
...
open class DataFetcherFactoriesRedefinition {
    ...
    companion object {
        ...
        private fun <
            T: DataFetchingEnvironment?, U: Any?, R: Any?
            > BiFunction<T, U, R>.applyResultValue(t: T, u: U): R {
            @Suppress("UNCHECKED_CAST")
            val value = when (u) {
        ...
        private fun handleDataFetcherResult(u: DataFetcherResult<*>): DataFetcherResult<*> {
            if (u.errors.isNotEmpty() && u.data == null)
                throw DataFetcherErrThrower(u)
            return u
        }
