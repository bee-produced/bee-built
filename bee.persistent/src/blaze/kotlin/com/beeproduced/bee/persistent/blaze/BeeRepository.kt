...
interface BeeBlazeRepository<T : Any, ID : Any> {
  ...
  /**
   * Inserts new entity into db. Use [update] to update an already persisted entity, not [persist].
   */
  fun <E : T> persist(entity: E): E

  /**
   * Updates all non-relation dependent fields of an entity in db. Fields marked with
   * [jakarta.persistence.OneToOne] and so on will NOT be updated.
   */
  ...
  /**
   * Queries entity with specified relations from db. If [id] does not exist, null will be returned.
   */
