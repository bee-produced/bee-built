...
class BlazePatchByteBuddyListener : SpringApplicationRunListener {
  ...
  override fun contextPrepared(context: ConfigurableApplicationContext?) {
    runCatching {
        ...
        BlazeViewTypeObjectBuilderPatch.patchViewTypeObjectBuilder(byteBuddy)
        BlazeTupleInstantiatorPatch.patchTupleConstructorReflectionInstantiator(byteBuddy)
        BlazeAssignmentInstantiatorPatch.patchAssignmentConstructorReflectionInstantiator(byteBuddy)
