 ...
 * @version 2024-01-10
 */
data class NotEqualValuePredicate<T : Any>(val expression: Expression<T>, val value: T?) :
  PredicateExpression {
  override fun Predicate.expression(): Expression<*> = expression
  ...
  override fun <W : BaseWhereBuilder<W>> Predicate.applyBuilder(builder: W): W {
    ...
    return if (value != null) builder.where(expressionString).notEq(value)
