...
import com.beeproduced.bee.persistent.jpa.exceptions.UnsupportedRelationType
 ...
 * @version 2023-01-30
 */
class MemberInfo(val member: KProperty<*>, val field: Field) {
  val type: Class<*>
  ...
  init {
    ...
    if (
      Collection::class.java.isAssignableFrom(retClass) ||
