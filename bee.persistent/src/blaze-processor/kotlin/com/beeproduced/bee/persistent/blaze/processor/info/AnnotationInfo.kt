...
object AnnotationInfo {
  ...
  const val ANNOTATION_BEE_REPOSITORY =
    "com.beeproduced.bee.persistent.blaze.annotations.BeeRepository"
  const val ANNOTATION_ENABLE_BEE_REPOSITORIES =
    "com.beeproduced.bee.persistent.blaze.annotations.EnableBeeRepositories"
}
