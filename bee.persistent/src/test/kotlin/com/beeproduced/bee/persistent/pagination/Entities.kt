...
data class PaginatedFoxtrot(
    ...
    @Column(columnDefinition = "TIMESTAMP(6)")
    val createdOn: Instant,
    @OneToMany(mappedBy = "foxtrot", fetch = FetchType.LAZY)
    val infos: Set<FoxtrotInfo>? = null
...
data class FoxtrotInfo(
    ...
    @JoinColumn(name = "foxtrotId", referencedColumnName = "id", insertable = false, updatable = false)
