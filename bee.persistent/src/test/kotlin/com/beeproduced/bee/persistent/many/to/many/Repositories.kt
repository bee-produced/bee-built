 ...
 */
@Component
class FooRepository(@Qualifier("orderEntityManager") em: EntityManager) :
  BaseDataRepository<Foo, Long>(em)

@Component
class BarRepository(@Qualifier("orderEntityManager") em: EntityManager) :
  BaseDataRepository<Bar, Long>(em)

@Component
class FooBarRelationRepository(@Qualifier("orderEntityManager") em: EntityManager) :
