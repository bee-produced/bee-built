...
class IncubatingTest {
  ...
  // e.g. User -> CompanyMember -> Company (with no addresses) -> User -> CompanyMember -> Company
  // (with addresses)
  // Addresses will not be loaded when it is the same entity from before because it was already
  // queried
