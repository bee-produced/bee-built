...
class DataSelectionTest {
  ...
  fun `check contains`() {
    val selection =
      SimpleSelection(
        setOf(FieldNode("a", setOf(FieldNode("a2"))), FieldNode("b", setOf(FieldNode("b2"))))
      )
  ...
  fun `check subselect`() {
    val selection =
      SimpleSelection(
        setOf(
          FieldNode("a", setOf(FieldNode("a2", setOf(FieldNode("a3"))))),
          FieldNode("b", setOf(FieldNode("b2", setOf(FieldNode("b3"))))),
        )
      )
  ...
  fun `check subselect with glob patterns`() {
    val selection =
      SimpleSelection(
        setOf(
          FieldNode("aaa", setOf(FieldNode("a2", setOf(FieldNode("a3"))))),
          FieldNode("bbb", setOf(FieldNode("b2", setOf(FieldNode("b3"))))),
        )
      )
  ...
  fun `check contains after merge`() {
    val selection1 = SimpleSelection(setOf(FieldNode("a", setOf(FieldNode("a2")))))
    val selection2 = SimpleSelection(setOf(FieldNode("b", setOf(FieldNode("b2")))))
  ...
  fun `check subselect after merge`() {
    val selection1 =
      SimpleSelection(setOf(FieldNode("a", setOf(FieldNode("a2", setOf(FieldNode("a3")))))))
    val selection2 =
      SimpleSelection(setOf(FieldNode("b", setOf(FieldNode("b2", setOf(FieldNode("b3")))))))
    val selection = selection1.merge(listOf(selection2))
  ...
  fun `check subselect with glob patterns after merge`() {
    val selection1 =
      SimpleSelection(setOf(FieldNode("aaa", setOf(FieldNode("a2", setOf(FieldNode("a3")))))))
    val selection2 =
      SimpleSelection(setOf(FieldNode("bbb", setOf(FieldNode("b2", setOf(FieldNode("b3")))))))
    val selection = selection1.merge(listOf(selection2))
  ...
  fun `check subselect with glob patterns after merge with same initial fields`() {
    val selection1 =
      SimpleSelection(
        setOf(
          FieldNode("aaa", setOf(FieldNode("a2", setOf(FieldNode("a3"))))),
          FieldNode("bbb", setOf(FieldNode("c2", setOf(FieldNode("c3"))))),
        )
      )
    val selection2 =
      SimpleSelection(setOf(FieldNode("bbb", setOf(FieldNode("b2", setOf(FieldNode("b3")))))))
