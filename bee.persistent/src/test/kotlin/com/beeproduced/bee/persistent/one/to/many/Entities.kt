 ...
 * @version 2023-02-07
 */
data class WorkId(val id: Long = -1, val worksKey: Long = -1) : Serializable
...
data class Work(
  ...
  @Id @Column(name = "works_id") val worksKey: Long,
  val txt: String,
...
data class WorkCollection(
  @Id @GeneratedValue val id: Long,
  @OneToMany(fetch = FetchType.LAZY, mappedBy = "works") val works: Set<Work>?,
