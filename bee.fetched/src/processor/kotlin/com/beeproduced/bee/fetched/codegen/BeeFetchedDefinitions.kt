 ...
 * @version 2023-10-14
 */
data class DgsDto(val name: String, val properties: List<PropertyDetails>)
...
data class PropertyDetails(
  ...
  fun toPoetTypename(): TypeName {
    val cls =
      if (isCollection) {
        ClassName("kotlin.collections", "List").parameterizedBy(nonCollectionType.toPoetClassName())
...
data class DataLoaderDefinition(
  ...
  // IR lowering
  // File being compiled:
  // C:/.../lib.data/src/dgs/kotlin/com/beeproduced/data/dgs/processor/AutoFetcherVisitor.kt
...
data class FetcherIgnoreDefinition(val target: String, val property: String?)
