package com.beeproduced.bee.persistent.application.configuration
...
class DateTimeScalar : Coercing<Instant?, String?> {
  companion object {
    // See:
    // https://java2blog.com/format-instant-to-string-java/#Format_Instant_to_String_in_ISO-8601_format
