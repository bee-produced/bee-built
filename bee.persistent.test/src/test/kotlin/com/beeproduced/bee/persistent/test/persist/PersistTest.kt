...
class PersistTest(
  ...
  @Autowired val objectIdRepo: GeneratedObjectIdRepository,
  @Autowired val primitiveRepo: GeneratedPrimitiveIdRepository,
  @Autowired val inlineRepo: GeneratedInlineIdRepository,
) {
  ...
  fun `persist implementation details`() {
    ...
    assertThrows<Exception> {
      transaction.executeWithoutResult {
        ...
        val idField2 =
          GeneratedPrimitiveId::class.java.getDeclaredField("id").apply { isAccessible = true }
    ...
    transaction.executeWithoutResult {
      val idField =
        GeneratedObjectId::class.java.getDeclaredField("id").apply { isAccessible = true }
      ...
      val default = GeneratedPrimitiveId::class.java.getConstructor().newInstance()
